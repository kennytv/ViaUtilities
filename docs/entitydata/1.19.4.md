...
| Index | Data Type   | Field Name                      |
|-------|-------------|---------------------------------|
| 8     | Integer     | INTERPOLATION_START_DELTA_TICKS |
| 9     | Integer     | INTERPOLATION_DURATION          |
| 10    | Vector3f    | TRANSLATION                     |
| 11    | Vector3f    | SCALE                           |
| 12    | Quaternionf | LEFT_ROTATION                   |
| 13    | Quaternionf | RIGHT_ROTATION                  |
| 14    | Byte        | BILLBOARD_RENDER_CONSTRAINTS    |
| 15    | Integer     | BRIGHTNESS_OVERRIDE             |
| 16    | Float       | VIEW_RANGE                      |
| 17    | Float       | SHADOW_RADIUS                   |
| 18    | Float       | SHADOW_STRENGTH                 |
| 19    | Float       | WIDTH                           |
| 20    | Float       | HEIGHT                          |
| 21    | Integer     | GLOW_COLOR_OVERRIDE             |
...
| Index | Data Type | Field Name   |
|-------|-----------|--------------|
| 22    | ItemStack | ITEM_STACK   |
| 23    | Byte      | ITEM_DISPLAY |
...
|-------|-----------|------------------|
| 22    | Component | TEXT             |
| 23    | Integer   | LINE_WIDTH       |
| 24    | Integer   | BACKGROUND_COLOR |
| 25    | Byte      | TEXT_OPACITY     |
| 26    | Byte      | STYLE_FLAGS      |
